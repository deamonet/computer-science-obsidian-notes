作者： [Tatu Ylonen](https://www.ssh.com/ssh/port) 译者： [LCTT](https://linux.cn/lctt/) [kenneth](https://linux.cn/lctt/kenxx)  | 2017-05-04 16:15
...
端口号可以在配置文件 [/etc/ssh/sshd_config](https://www.ssh.com/ssh/sshd_config/) 中将 `Port 22` 更改。也可以使用 `-p <port>` 选项运行 [sshd](https://www.ssh.com/ssh/sshd/)。SSH 客户端和 [sftp](https://www.ssh.com/ssh/sftp/) 程序也可以使用 `-p <port>` 选项。
...
via: [https://www.ssh.com/ssh/port](https://www.ssh.com/ssh/port)
